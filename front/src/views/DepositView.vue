  ...
  <div class="outer container">
    <div class="link">
      ...
      <div style="white-space: nowrap">
        <h3>
          <span style="font-weight: bold;">정기예금</span>
          <span><a href="http://localhost:5173/compare/savings" style="text-decoration: none; color: black;"> 정기적금</a></span>
        </h3>        
      </div>
    </div>
    <hr />
    <div class="container mt-5">
      <table class="table table-bordered table-striped">
        ...
        <tbody style="font-size: small">
          <tr v-for="product in store.deposit">
            <td>{{ product.dcls_month }}</td>
            <td>{{ product.kor_co_nm }}</td>
            <td>
              <RouterLink
                :to="{ name: 'deposit_detail', params: { id: product.id } }"
